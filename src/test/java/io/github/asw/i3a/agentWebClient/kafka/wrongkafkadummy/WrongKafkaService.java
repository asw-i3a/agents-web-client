package io.github.asw.i3a.agentWebClient.kafka.wrongkafkadummy;
...
public class WrongKafkaService {
	...
	private KafkaTemplate<String, String> kafkaTemplate = new WrongKafkaProduceFactory()
			.wrongkafkaTemplate();
	...
	private boolean send( String topic, String data ) {
		...
		future.addCallback( new ListenableFutureCallback<SendResult<String, String>>() {
			...
			public void onFailure( Throwable ex ) {
				logger.error( "ERROR on sending message \"" + data + "\", stacktrace "
						+ ex.getMessage() );
			}
		} );
